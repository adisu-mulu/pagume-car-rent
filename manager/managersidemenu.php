...
$ct= "SELECT *from car_requests, employees, drivers,vehicles, account where car_requests.car=vehicles.plate and
   ...
   ?>
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="requests.php"><i class="app-menu__icon fa fa-users fa-1x"></i><span
                    class="app-menu__label">Requests <i style="color: red"><?php if($crs->rowCount()>0) echo $crs->rowCount();?></i></span></a></li>
