...
<body class="app sidebar-mini rtl">
    ...
    <?php include "financesidemenu.php" ?>
    <main class="app-content">
        <div class="app-title">
          ...
          <div class="row" id="list">
            <div class="col-md-12">
            <h3 id="fa" style="display: none;"><i class="fa fa-th-list"></i> Request Approved</h3>
                <h3 id="fna" style="display: none;"><i class="fa fa-th-list"></i> Request Not Approved</h3>
                <div class="tile">
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="../crud.php?faprId=<?php echo $val['rq_id'];?>"><i><?php echo $val['req_status']; ?></i></a></td>    
                                </tr>
                                <?php
 ...
 if(isset($_GET["frA"])){
    if($_GET["frA"]=="y") 
    {
    echo "<script>document.getElementById('fa').style.display='block'; </script>"; 
    }
    else {
    echo "<script>document.getElementById('fna').style.display='block'; </script>";
    }
}
