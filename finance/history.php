...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1 id="listVehicleLabel"><i class="fa fa-th-list"></i>Approved By Finance</h1>
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody>
                                ...
                                $query= "SELECT *from car_requests, employees, drivers,vehicles, account where car_requests.car=vehicles.plate and
                                 ...
                                 and  car_requests.f_approve IS NOT NULL";
                                $res = $obj->fetch($query);
                                $result = $res->fetchAll();
